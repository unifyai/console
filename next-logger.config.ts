  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        "card-border": "linear-gradient(90deg, rgba(122, 185, 138, 0.75) 2.01%, rgba(0, 174, 36, 0.75) 100.01%)",
        "button-gradient": "linear-gradient(108deg, #66D47E 6.9%, #00A824 104.93%)",
        "green-grad-75": "linear-gradient(129deg, rgba(102, 212, 126, 0.75) -3.33%, rgba(0, 184, 40, 0.75) 50.35%, rgba(102, 212, 126, 0.75) 114.95%)",
      },
      colors: {
        "accent": "#00a824",
