...
const buildFilterExpression = (
  ...
  switch (deadlineFilter) {
    ...
    case 'today':
      filters.push(
        `deadline >= '${todayStart.toISOString()}' and deadline <= '${todayEnd.toISOString()}'`
      );
      break;
    case 'tomorrow':
      ...
      filters.push(
        `deadline >= '${tomorrowStart.toISOString()}' and deadline <= '${tomorrowEnd.toISOString()}'`
      );
      break;
    case 'this_week':
      ...
      filters.push(
        `deadline >= '${weekStart.toISOString()}' and deadline <= '${weekEnd.toISOString()}'`
      );
      break;
    case 'no_deadline':
