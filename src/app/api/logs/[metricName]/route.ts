...
export async function GET(
    ...
    try {
        ...
        console.error(JSON.stringify({ route: "/api/logs/[metricName]", method: "GET", upstream: `${baseUrl}/logs/metric/${params.metricName}${url.search}`, error: msg, latencyMs: Date.now() - startedAt, correlationId }));
