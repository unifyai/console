...
export type ModelInputPrimitiveType<T extends ArgumentType> = T extends 'int'
  ? number
  : T extends 'string'
    ? string
    : T extends 'bool'
...
export type ModelInputType<T extends Argument> = T extends ArgumentList
  ? ModelInputPrimitiveType<T['elementType']>[]
  : T extends ArgumentObject
    ? ModelInputs<T['fields']>
    : T extends ArgumentChatHistory
      ? ChatInputs<T['structure']>
      : T extends ArgumentInt
        ? number
        : T extends ArgumentString
          ? string
          : T extends ArgumentBool
            ? boolean
            : never;
