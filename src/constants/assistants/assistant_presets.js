const assistantPresets = [
  ...
  },
  {
    ...
    nationality: 'United Kingdom',
    profilePhoto: 'https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait/male/512/56.jpg',
    voiceIds: {
      elevenlabs: 'ZQe5CZNOzWyzPSCn5a3c', // James (en, male, old, calm, australian accent)
    },
  },
  {
    ...
    nationality: 'United Kingdom',
    profilePhoto: 'https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait/male/512/16.jpg',
    voiceIds: {
      elevenlabs: '29vD33N1CtxCmqQRPOHJ', // Drew (en, male, middle-aged, well-rounded)
    },
  },
  {
    ...
    nationality: 'United Kingdom',
    profilePhoto: 'https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait/male/512/96.jpg',
    voiceIds: {
      elevenlabs: 'ErXwobaYiN019PkySvjV', // Antoni (en, male, young, well-rounded)
    },
  },
  {
    ...
    nationality: 'United Kingdom',
    profilePhoto: 'https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait/male/512/48.jpg',
    voiceIds: {
      elevenlabs: 'cjVigY5qzO86Huf0OWal', // Eric (en, male, middle-aged, classy, smooth tenor)
    },
  },
  {
    ...
    nationality: 'United Kingdom',
    profilePhoto: 'https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait/female/512/59.jpg',
    voiceIds: {
      elevenlabs: 'cgSgspJ2msm6clMCkdW9', // Jessica (en, female, young and playful American voice)
    },
  },
  {
    ...
    nationality: 'United Kingdom',
    profilePhoto: 'https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait/female/512/88.jpg',
    voiceIds: {
      elevenlabs: 'AZnzlk1XvdvUeBnXmlld', // Domi (en, female, young, strong)
    },
  },
