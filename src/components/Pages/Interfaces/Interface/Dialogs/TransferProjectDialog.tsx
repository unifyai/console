...
export const TransferProjectDialog = React.memo(function TransferProjectDialog({
    ...
    const handleTransferToPersonal = useCallback(async () => {
        ...
        try {
            ...
            showSuccessToast('Project transferred', 'Project has been transferred to your personal account')
            onTransferComplete()
            onOpenChange(false)
                    ...
                    {isOrgProject ? (
                        ...
                        <>
                            ...
                            <p className="text-body-sm text-muted-foreground">
                                The project will be moved from the organization to your personal account.
                                All collaboration settings will be removed.
                            </p>
                        </>
                    ) : (
