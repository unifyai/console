...
const DefaultProject = ({
  ...
  const {
    ...
    tab: demoTab,
    tiles: demoTiles,
  } = demos[Object.keys(demos).includes(demo || '') ? demo || '' : Object.keys(demos)[0]];
  ...
  useEffect(() => {
    if (demo == null) setDemo(Object.keys(demos)[0]);
  ...
  return (
    <>
      <div className="flex h-[94vh] flex-col items-center gap-4">
        <div className="text-strong mt-4 flex justify-center">
          {create && isPending
        ...
        <div className="my-auto">
          {isError && (
            <div className="my-2 text-destructive">Error running demo, please try again.</div>
          )}
          <div className="flex gap-8">
              ...
              <div className="mb-1 flex flex-col items-center gap-4">
                <div className="flex w-full gap-4">
                  <div className="w-fit">
                    ...
                    >
                      <div className="command-scrollbar max-h-[80vh] overflow-y-auto">
                        {Object.entries(demosTree.children)
                          .sort((a, b) => {
                ...
                <div className="text-body text-strong w-[600px]">{demoDescription}</div>
            ...
            <div className="command-scrollbar border-1 relative mb-auto h-[400px] w-[600px] overflow-y-auto rounded-md border p-2">
              <CodeBlock
                code={demoCode}
                language="python"
      ...
      <Dialog open={imageDialog} onOpenChange={setImageDialog}>
        <DialogContent className="max-h-[800px] max-w-[1400px]">
          <Image
            key={demoGif}
            src={`https://raw.githubusercontent.com/unifyai/unifyai.github.io/main/img/externally_linked/docs/${demoGif}.gif`}
            alt="GIF"
