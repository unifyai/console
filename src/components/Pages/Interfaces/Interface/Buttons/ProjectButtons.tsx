    ...
    const handleToggleFavourite = async () => {
        ...
        try {
            if (currentFavourite) {
                ...
                const newFavourite = await favouritesActions.create(project, 'layout-dashboard', newPosition);
                if (newFavourite) {
                ...
                <ActionButton
                    ...
                    icon={
                        isFavouriting ? (
                            ...
                            <Star
                                className={`h-4 w-4 ${
                                    currentFavourite ? "fill-yellow-400 text-yellow-400" : ""
                                }`}
                            />
                        )
                    }
                        ...
                        <>
                            <div className="w-full border-b py-1">
                                <BaseDialog
                                    ...
                                    footer={
                                        <SubmitButton onClick={handleRenameProject} text="Rename" />
                                    }
                                />
                            </div>
                            <div className="w-full border-b py-1">
