...
import { GranularInterfaceActions, GranularTabActions, GranularTileActions, InterfaceData, InterfaceTemplateSchema, TemplateExportResponse, TemplateImportResponse, ProjectsActions } from "@/types/interfaces/grid";
...
export default function InterfaceSelector({
  ...
  useEffect(() => {
    if (!isLoading && !isFetching && Array.isArray(interfaces) && interfaces.length === 0 && projectId && !isCreatingDefault) {
  ...
  }, [isLoading, isFetching, interfaces, projectId, isCreatingDefault, queryClient, interfaceActions, tabActions, tileActions, searchParams, router]);
      ...
      <div className="w-full h-full overflow-auto relative bg-background">
        <div className="container mx-auto py-6 space-y-6">
          <Card className="shadow-sm">
            ...
            <CardContent className="space-y-4 pt-10 flex flex-col items-center justify-center min-h-[300px]">
