...
interface EmptyTableOverlayProps {
    ...
    contextSelectorContent?: React.ReactNode;
    withPulse?: boolean;
}
...
const EmptyTableOverlay: React.FC<EmptyTableOverlayProps> = ({
    ...
    return (
        <div className="absolute inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-30">
            <div className={`bg-background border rounded-lg ${mode != "context" ? "p-6 max-w-sm" : "max-w-lg"} mx-4 shadow-lg text-center relative`}>
                <button
                    onClick={onDismiss}
