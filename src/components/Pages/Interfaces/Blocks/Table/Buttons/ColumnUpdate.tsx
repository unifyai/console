...
import { expressionToDerivedFunction, derivedFunctionToExpression } from "@/utils/interfaces/table/derivedColumns";
...
const ColumnUpdate = ({
    ...
    const warning = (error: string) => 
                    <p className="flex justify-start text-body-sm text-destructive">{error}</p>
