  ...
  const onClick = () => {
    ...
    if (isParentColumn) {
      ...
      if (isGrouped) {
        ...
        newGrouping = grouping.filter((id) => !childColumns.some((col) => col.columnDef.id === id));
        ...
        newGrouping = [
          ...
          ...(childColumns
            ...
            .filter((id) => !grouping.includes(id as string)) as string[]),
        ];
  ...
  return renderMode === 'menuItem' ? (
    ...
    <div className="group relative inline-flex">
      <ActionButton
        ...
        variant={variant}
        onClick={onClick}
        disabled={interactive == false || autoUpdate}
      />
      {isGrouped && (
        <button
          onClick={onClick}
