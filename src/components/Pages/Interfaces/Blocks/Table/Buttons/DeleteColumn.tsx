...
const ColumnDelete = ({
  ...
  const sanitizedField = columnContext
    ? processContext('merge', columnContext, sanitizeId(column))
    : sanitizeId(column);
  ...
  return (
    ...
    >
      <div onClick={handleButtonClick} className="flex flex-row items-center gap-2">
