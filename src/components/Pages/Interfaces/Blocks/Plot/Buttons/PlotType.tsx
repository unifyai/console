...
import { clearCanvas } from '@/utils/interfaces/plots/canvas';
  ...
  return (
    <AccordionItem value="plot-type">
      <AccordionTrigger disabled={!interactive}>
        <Tooltip
          content="Determines the type of data that can be plotted and how it is displayed"
          side="left"
        >
      ...
      <AccordionContent>
        <div className="space-y-1 pr-2">
          {plotTypes.map((pt) => (
            ...
            >
              {plotIcons[pt as keyof typeof plotIcons]?.icon || <span className="h-4 w-4"></span>}
