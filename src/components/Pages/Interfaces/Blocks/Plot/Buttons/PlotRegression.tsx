...
const triggerStyles =
  'flex flex-1 items-center gap-2 py-1 text-label hover:underline rounded transition-colors cursor-pointer';
...
const PlotRegression = ({
  ...
  return (
    <div className="flex items-center justify-between py-1.5">
      <Tooltip
        content="Draw the line of best fit, and one line per group if grouping is applied."
        side="left"
      >
        <Label
          htmlFor="regression-switch"
