  ...
  return (
    <>
      ...
      <Table className="QueriesTable">
        <TableCaption>
          {queries.length ? "" : "You haven't made any API calls yet."}
        </TableCaption>
          ...
          <SheetContent side="right" className="flex flex-col sm:max-w-3xl w-full">
            ...
            <ScrollArea className="flex-1 px-6">
              <div className="py-4 space-y-4">
                ...
                <div>
                  <strong>Date:</strong>{" "}
                  {new Date(selectedQuery.at).toLocaleString()}
                </div>
                <div>
                ...
                <div>
                  ...
                  {selectedQuery.endpoint.split("@")[1]}
                </div>
                <div>
                  <strong>Tags:</strong>{" "}
                  {selectedQuery.tags?.join(", ") || "No tags"}
                </div>
