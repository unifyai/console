  ...
  return (
    <BaseDialog
      ...
      body={
        onPrem ? (
          <p>
            You can{"'"}t regenerate your API key in an on-prem setup. Visit our platform for
            assistance.
          </p>
        ) : (
          <p>
            Regenerating the API key will disable your current key and create a new one. Proceed?
          </p>
        )
      }
      footer={
