...
const EndpointsTableCell = ({
  ...
  else if (column.id === 'code') content = cell.renderValue() as string;
  else
    content = (
      <div className="flex items-center space-x-2">
        <Image
          src={row.original.providerImage}
          alt={provider}
          width={20}
          height={20}
          className="my-auto"
  ...
  return <TableCell key={cell.id}>{flexRender(content, cell.getContext())}</TableCell>;
};
