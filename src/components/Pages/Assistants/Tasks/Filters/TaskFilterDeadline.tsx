...
export function TaskDeadlineFilter({
  ...
  const selectedIconClassName =
    deadlineOptions.find((opt) => opt.value === deadlineFilter)?.iconClassName || '';

  return (
    <div className="relative">
      <Select value={deadlineFilter} onValueChange={setDeadlineFilter} disabled={disableFilters}>
        <SelectTrigger className="h-8 w-[160px] flex-shrink-0">
