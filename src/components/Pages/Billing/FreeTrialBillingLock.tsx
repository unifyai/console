      ...
      <Card className="max-w-md text-center">
        <CardContent className="flex flex-col items-center gap-4 pb-8 pt-8">
          ...
          <div className="space-y-2">
            <h2 className="text-h3">Billing is locked during your free trial</h2>
            <p className="text-body-muted">
              Billing management is available beyond the free trial.{' '}
              <a
                href={CONTACT_URL}
                target="_blank"
...
export default FreeTrialBillingLock;
