  ...
  const CreateSchema = z.object({
    name: z
      ...
      .refine(
        ...
        {
          message:
            "Custom provider must be one of 'custom', 'custom-openai', 'custom-mistral', 'custom-vertex-ai', 'custom-fireworks-ai', 'custom-together-ai'",
        }
      ),
    url: z.string().url().min(1, { message: 'URL must be at least 1 character.' }),
    keyName: z
      .string()
