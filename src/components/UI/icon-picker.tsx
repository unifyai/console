      ...
      (icon: IconData) => (
        <TooltipProvider key={icon.name}>
          <Tooltip>
            <TooltipTrigger
              className={cn(
                'hover:bg-foreground/10 cursor-pointer rounded-md border p-2 transition',
            ...
            if (item.type === 'category') {
              return (
                <div key={virtualItem.key} style={itemStyle} className="top-0 z-10 bg-background">
                  <h3 className="text-caption text-strong select-none capitalize">
    ...
    return (
      <Popover open={open ?? isOpen} onOpenChange={handleOpenChange}>
        ...
        <PopoverContent className="w-64 p-2">
          ...
          <div ref={parentRef} className="command-scrollbar max-h-60 overflow-auto">
