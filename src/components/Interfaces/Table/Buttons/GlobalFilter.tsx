...
const GlobalFilter = ({ interactive, commonFilter, setCommonFilter, logs, currentTable, tableArguments }: {
    interactive: boolean,
    ...
    /* Mode toggler */
    const modeIcon = loading ? <LoaderCircle className="animate-spin text-primary"/> : mode === "search" ? <Search/> : <TbMathFunction/>
    const modeTooltip = loading ? "Filtering logs.." : mode === "search" ? "Toggle function mode" : "Toggle search mode"
