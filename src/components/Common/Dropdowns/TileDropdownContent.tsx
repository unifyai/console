...
*/
type ForwardedDropdownContentProps = Omit<ComponentPropsWithoutRef<typeof DropdownMenuContent>, 'children' | 'side' | 'style'>;
...
export default function TileDropdownContent({
    ...
    const tileStyle = (tileColor ? { "--primary": tileColor, "--accent": tileColor } : {}) as CSSProperties;
