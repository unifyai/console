...
describe('Organization Management System', () => {
  ...
  describe('Organization Lifecycle', () => {
    it(
      'should allow a user to create a new organization successfully',
      {
        meta: {
          alias: 'create-org-success',
          behavior:
            'User creates a new organization which triggers server action and workspace switch',
    ...
    it(
      'should handle duplicate organization name errors gracefully',
      {
        meta: {
      ...
      async () => {
        ...
        await waitFor(() => {
          expect(
            screen.getByText(/organization with this name already exists/i)
          ).toBeInTheDocument();
        });
    ...
    it(
      'should allow renaming an organization',
      {
        meta: {
    ...
    it(
      'should support organization deletion with confirmation',
      {
        meta: {
          alias: 'delete-org',
          behavior:
            'Deleting organization requires confirmation and redirects to personal workspace',
  ...
  describe('Member Management & RBAC', () => {
    ...
    it(
      'should validate email format before sending invite',
      {
        meta: {
    ...
    it(
      'should hide administrative actions for non-admin users',
      {
        meta: {
    ...
    it(
      'should filter member list based on search query',
      {
        meta: {
          alias: 'member-search',
    ...
    it(
      'should allow removing an existing member',
      {
        meta: {
          alias: 'remove-member',
    ...
    it(
      'should allow resending an invitation',
      {
        meta: {
          alias: 'resend-invite',
    ...
    it(
      'should allow cancelling a pending invitation',
      {
        meta: {
          alias: 'cancel-invite',
  ...
  describe('Team Management', () => {
    ...
    it(
      ...
      async () => {
        ...
        expect(mockTeamActions.updateTeam).toHaveBeenCalledWith(
          1,
          101,
          'Core Engineering',
          'Core dev team'
  ...
  describe('Role & Permission Management', () => {
    ...
    it(
      'should create a custom role with specific permissions',
      {
        meta: {
          alias: 'create-role',
      ...
      async () => {
        ...
        expect(mockRoleActions.createRole).toHaveBeenCalledWith(
          1,
          'Viewer',
          '',
    ...
    it(
      'should add a permission to an existing custom role',
      {
        meta: {
