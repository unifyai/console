 ...
 *   - ~120 transcript messages across 7 days
 *   - 2 Knowledge sub-contexts: Products (12 rows), FAQ (8 rows)
 *   - 15 tasks with varied statuses
 *   - 10 guidance entries
