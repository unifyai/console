...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `auth.core`            | completes login with valid credentials; shows error for invalid password; shows error when email is not registered; shows provider conflict; completes full registration; selects personal workspace and redirects |
