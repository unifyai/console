...
import { renderPlotTile, createMockPlotData, PlotType } from '../behavior/fixtures/plotTileTestHarness';
...
describe('Plot Rendering Integration', () => {
  ...
  describe('A: Complete Plot Type Transitions', () => {
    ...
    it('transitions through all plot types correctly',
    {
      meta: {
    ...
    it('preserves grouping across plot type changes',
    {
      meta: {
    ...
    it('clears type-specific settings on plot type change',
    {
      meta: {
  ...
  describe('B: Settings Panel Interactions', () => {
    ...
    it('settings changes apply immediately to plot',
    {
      meta: {
    ...
    it('shows plot-type-specific settings',
    {
      meta: {
  ...
  describe('C: Focus Mode Integration', () => {
    ...
    it('enters and exits focus mode correctly',
    {
      meta: {
    ...
    it('maintains plot state during focus mode',
    {
      meta: {
    ...
    it('can modify settings while in focus mode',
    {
      meta: {
  ...
  describe('D: Data Interaction Integration', () => {
    ...
    it('tooltip shows correct data for grouped points',
    {
      meta: {
    ...
    it('hover effects work with zoom enabled',
    {
      meta: {
    ...
    it('hover effects work with regression line shown',
    {
      meta: {
  ...
  describe('E: Multi-Feature Combinations', () => {
    ...
    it('handles all scatter features enabled simultaneously',
    {
      meta: {
    ...
    it('rapid feature toggling does not cause errors',
    {
      meta: {
  ...
  describe('F: Callbacks Integration', () => {
    ...
    it('all callbacks fire correctly during complex workflow',
    {
      meta: {
