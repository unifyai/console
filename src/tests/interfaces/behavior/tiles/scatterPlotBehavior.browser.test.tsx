...
describe('Scatter Plot Behaviors', () => {
  ...
  describe('A: Data Point Interactions', () => {
    ...
    it('highlights data point on hover',
    {
      meta: {
    ...
    it('dims non-hovered points on hover',
    {
      meta: {
    ...
    it('restores point appearance on mouse leave',
    {
      meta: {
    ...
    it('shows tooltip with point data on hover',
    {
      meta: {
  ...
  describe('B: Regression Line', () => {
    ...
    it('shows regression line when enabled',
    {
      meta: {
    ...
    it('hides regression line when disabled',
    {
      meta: {
    ...
    it('displays correlation coefficient with regression line',
    {
      meta: {
    ...
    it('triggers callback when regression is toggled',
    {
      meta: {
  ...
  describe('C: Scale Controls', () => {
    ...
    it('changes X axis to log scale',
    {
      meta: {
    ...
    it('changes Y axis to log scale',
    {
      meta: {
    ...
    it('stores scale type in SVG data attribute',
    {
      meta: {
  ...
  describe('D: Zoom Behavior', () => {
    ...
    it('triggers callback when zoom is toggled',
    {
      meta: {
    ...
    it('maintains zoom container transform structure',
    {
      meta: {
  ...
  describe('E: Grouping and Colors', () => {
    ...
    it('applies different colors when grouped by category',
    {
      meta: {
    ...
    it('shows legend when color by is selected',
    {
      meta: {
    ...
    it('hides legend when color by is cleared',
    {
      meta: {
  ...
  describe('F: Plot Type Switching', () => {
    ...
    it('maintains data when switching from scatter to line',
    {
      meta: {
    ...
    it('maintains data when switching from scatter to bar',
    {
      meta: {
    ...
    it('hides scatter-specific settings when switching to histogram',
    {
      meta: {
        alias: 'Scatter-Switch-HideSettings',
        scenario: "User switches from scatter to histogram.",
        behavior: "Scatter-specific settings (regression, scale) are hidden and histogram settings appear."
      }
    },
    async () => {
      const user = userEvent.setup();
  ...
  describe('G: Edge Cases', () => {
    ...
    it('handles rapid settings changes',
    {
      meta: {
    ...
    it('handles toggling settings panel during focus mode',
    {
      meta: {
