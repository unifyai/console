...
describe('Histogram Behaviors', () => {
  ...
  describe('A: Bin Rendering', () => {
    it(
      'renders histogram bins correctly',
      {
        meta: {
    ...
    it(
      'hides tooltip on mouse leave from bin',
      {
        meta: {
  ...
  describe('B: Bin Count Controls', () => {
    it(
      'shows bin count slider in settings',
      {
        meta: {
    ...
    it(
      'displays current bin count value',
      {
        meta: {
    ...
    it(
      'updates bin count when slider is changed',
      {
        meta: {
    ...
    it(
      're-renders bins when count changes',
      {
        meta: {
  ...
  describe('C: Histogram-Specific Settings', () => {
    it(
      'hides scale controls for histogram',
      {
        meta: {
    ...
    it(
      'hides regression toggle for histogram',
      {
        meta: {
    ...
    it(
      'hides zoom toggle for histogram',
      {
        meta: {
    ...
    it(
      'shows color by control for histogram',
      {
        meta: {
  ...
  describe('D: Plot Type Switching', () => {
    it(
      'switches from scatter to histogram',
      {
        meta: {
    ...
    it(
      'switches from histogram to bar',
      {
        meta: {
    ...
    it(
      'shows bin count control when switching to histogram',
      {
        meta: {
  ...
  describe('E: Edge Cases', () => {
    it(
      'handles minimum bin count (1 bin)',
      {
        meta: {
    ...
    it(
      'handles rapid bin count changes',
      {
        meta: {
  ...
  describe('F: Grouping', () => {
    it(
      'shows legend when grouped by category',
      {
        meta: {
