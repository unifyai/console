...
| Priority | Category | Behaviors | Status |
|----------|----------|-----------|--------|
| P1 | Log Table - Basic | 12 | ✅ Complete |
| P1 | Log Table - Advanced | 17 | ✅ Complete |
| P1 | Tab Management | 8 | ✅ Complete |
| P2 | Tile Layout | 9 | ✅ Complete |
| P2 | Edit Mode | 5 | ✅ Complete |
| P2 | Plot Tile | 8 | ✅ Complete |
| P2 | Editor Tile | 8 | ✅ Complete |
| P2 | Selection Panel | 16 | ✅ Complete |
| P3 | Context Management | 5 | 🔴 Not Started |
| P3 | Checkpoints & Templates | 6 | 🔴 Not Started |
| P3 | File Operations | 5 | 🔴 Not Started |
| P4 | Project Selection | 5 | 🔴 Not Started |
| P4 | Interface Selection | 4 | 🔴 Not Started |
| P4 | Sidebar Navigation | 7 | 🔴 Not Started |
| P5 | Terminal Tile | 5 | 🔴 Not Started |
| P5 | Error Handling | 6 | 🔴 Not Started |
| P5 | Keyboard & Accessibility | 8 | 🔴 Not Started |
| **Total** | | **134** | |
...
### J. Checkpoints & Templates (`checkpointsTemplates.browser.test.tsx`)

Checkpoints save interface state; templates allow sharing configurations.

| ID | Behavior | Scenario | Expected Outcome | Notes |
|----|----------|----------|------------------|-------|
| J1 | Save checkpoint | Click save, enter name, confirm | Checkpoint created, appears in checkpoint list | Includes all tabs/tiles state |
| J2 | Restore checkpoint | Click restore on existing checkpoint | Interface state reverts to checkpoint state | Warning if unsaved changes |
| J3 | Delete checkpoint | Click delete on checkpoint, confirm | Checkpoint removed from list | Cannot undo |
| J4 | Export template | Click export in interface menu | Template JSON downloaded | Browser download |
| J5 | Import template | Upload template JSON file | Interface configured from template | Validation on import |
| J6 | Template validation | Upload invalid template | Error message, import rejected | Shows specific error |
...
├── fixtures/
│   ├── dataTableTestHarness.tsx          # DataTable test harness (real component)
│   ├── tabSidebarTestHarness.tsx         # Tab sidebar test harness
│   └── tileGridTestHarness.tsx           # Tile grid test harness
│
├── log-table/
...
│   ├── checkpointsTemplates.browser.test.tsx # J: Checkpoints & templates
│   └── fileOperations.browser.test.tsx       # K: File upload
│
├── navigation/                           # Future: P4
