...
describe('ProjectPermissions UI Behavior', () => {
    ...
    it('returns available teams and members for organization projects', () => {
        const mockTeams = [
            ...
            { id: 2, name: 'Design', organization_id: 100, created_at: '2024-01-01' },
        ];
        const mockMembers = [
            { id: 1, user_id: 'user-1', organization_id: 100, role_id: 1, role_name: 'Admin', created_at: '2024-01-01', name: 'John Doe', email: 'john@example.com' },
            { id: 2, user_id: 'user-2', organization_id: 100, role_id: 2, role_name: 'Member', created_at: '2024-01-01', name: 'Jane Smith', email: 'jane@example.com' },
        ];
