...
describe('useProjectPermissions', () => {
    ...
    it('should return true for project:write if user is owner (personal project)', async () => {
        const options = createMockOptions({
            projectData: {
                id: 1,
                name: 'test-project',
                user_id: 'user-123', // Same as userId - personal owner
                organization_id: null, // Personal project
            },
        });

        const { result } = renderHook(
            () => useProjectPermissions(options),
            ...
            rolesData: [
                {
                    ...
                    created_at: '2024-01-01T00:00:00Z',
                    permissions: [
                        { id: 1, name: 'project:read', resource_type: 'project', action: 'read', created_at: '2024-01-01T00:00:00Z' },
                    ],
                },
            ],
        });
            ...
            rolesData: [
                {
                    ...
                    permissions: [
                        { id: 1, name: 'project:read', resource_type: 'project', action: 'read', created_at: '2024-01-01T00:00:00Z' },
                        { id: 2, name: 'project:write', resource_type: 'project', action: 'write', created_at: '2024-01-01T00:00:00Z' },
                        { id: 3, name: 'project:delete', resource_type: 'project', action: 'delete', created_at: '2024-01-01T00:00:00Z' },
                    ],
                },
            ],
        });
    ...
    it('should expose accessEntries for sharing UI', async () => {
        ...
        expect(result.current.accessEntries[0].grantee_name).toBe('user@example.com');
        expect(result.current.accessEntries[1].grantee_type).toBe('team');
    });

    it('should expose availableRoles for role selection', async () => {
        const roles = [
            { id: 1, name: 'Owner', is_system_role: true, created_at: '2024-01-01T00:00:00Z', permissions: [] },
            { id: 2, name: 'Viewer', is_system_role: true, created_at: '2024-01-01T00:00:00Z', permissions: [] },
            { id: 3, name: 'Editor', is_system_role: true, created_at: '2024-01-01T00:00:00Z', permissions: [] },
        ];
    ...
    it('should expose availableTeams and availableMembers', async () => {
        const mockTeams = [
            { id: 1, name: 'Engineering', organization_id: 100, created_at: '2024-01-01' },
        ];
        const mockMembers = [
            { id: 1, user_id: 'user-1', organization_id: 100, role_id: 1, role_name: 'Admin', created_at: '2024-01-01', name: 'John', email: 'john@example.com' },
        ];
