...
} from '@/tests/_interfaces/mocks/fixtures/actions';
import { mockProjectId } from '@/tests/_interfaces/mocks/fixtures/projects';
import { mockInterface } from '@/tests/_interfaces/mocks/fixtures/interfaces';
import { mockTab } from '@/tests/_interfaces/mocks/fixtures/tabs';
import { createMockLogs, MOCK_LOGS_TOTAL_COUNT } from '@/tests/_interfaces/mocks/fixtures/logs';
