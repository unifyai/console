...
import { UnifyPrompt } from './unify-chat-prompt';

export function convertToUnifyChatMessages(prompt: LanguageModelV1Prompt): UnifyPrompt {
  const messages: UnifyPrompt = [];
