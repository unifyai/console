/**
 * Logging-related Orchestra API calls
 *
 * This file consolidates all direct Orchestra calls for query metrics and tags.
 * Uses the legacy Axios user client because these endpoints are not in the public OpenAPI spec.
 */
