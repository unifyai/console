...
export function updatePlotArgumentsForUsedTables(
  ...
  usedTableNames.forEach((tableName) => {
    ...
    if (tableTile.commonFilter)
      updatedPlotArguments[tableName].commonFilter = tableTile.commonFilter;
    ...
    if (tableTile.columnContext)
      updatedPlotArguments[tableName].columnContext = tableTile.columnContext;
  });
