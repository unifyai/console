...
import { DataPoint, GroupedDataPoint } from "@/types/evals/plot";
...
export const drawLineChart = (
  ...
  interactive: boolean = true
    ...
    const zoom = d3
        ...
        .on('end', () => onZoomEnd(g))
        .on('zoom', (event) => onZoom(event, zoomRef, initialX, lineGenerator, minY, maxY, scaleY, scaleY, svg, dimensions, margins, reverseX, reverseY, xAxisProperty, yAxisProperty, xType, y, groupBy, data, g));
